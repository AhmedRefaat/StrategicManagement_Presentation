...
<section><h2>Service portfolio</h2><div class="grid3"><div class="card"><div class="card-head"><img class="card-icon" src="${assetBase}icons/Design_Consultancy.png" alt="" /><h3>Design & consultancy</h3></div><p>Architecture, engineering, BIM, permits, supervision.</p></div><div class="card"><div class="card-head"><img class="card-icon" src="${assetBase}icons/Execution.png" alt="" /><h3>Execution</h3></div><p>Construction, civil works, finishing, project delivery.</p></div><div class="card"><div class="card-head"><img class="card-icon" src="${assetBase}icons/Real_Estate.png" alt="" /><h3>Real estate</h3></div><p>Development and marketing within integrated solutions.</p></div><div class="card"><div class="card-head"><img class="card-icon" src="${assetBase}icons/Smart_Technology.png" alt="" /><h3>Smart technology</h3></div><p>Automation, IoT, BMS, security, software.</p></div><div class="card"><div class="card-head"><img class="card-icon" src="${assetBase}icons/Energy.png" alt="" /><h3>Energy</h3></div><p>Solar systems, monitoring, energy management.</p></div><div class="card"><div class="card-head"><img class="card-icon" src="${assetBase}icons/After-Sales.png" alt="" /><h3>After-sales</h3></div><p>Support, maintenance, upgrades, integration.</p></div></div></section>
...
<section class="map-slide"><h2>Strategic group map</h2><img src="${assetBase}Strategic%20group%20map.jpeg" alt="Strategic group map comparing Al Rawae with direct industry peers by service integration and price level" /></section>
...
<section><h2>SPACE matrix strategic position</h2><div class="space-summary"><span>FS <strong>+4.83</strong></span><span>CA <strong>−2.33</strong></span><span>IS <strong>+3.83</strong></span><span>ES <strong>−3.67</strong></span><span class="space-result">X = IS + CA = <strong>+1.50</strong> &nbsp; · &nbsp; Y = FS + ES = <strong>+1.16</strong></span></div><div class="space-matrix" aria-label="SPACE matrix: Al Rawae is positioned in the aggressive quadrant at plus 1.50, plus 1.16"><div class="space-quadrant conservative">Conservative</div><div class="space-quadrant aggressive">Aggressive</div><div class="space-quadrant defensive">Defensive</div><div class="space-quadrant competitive">Competitive</div><div class="space-axis space-axis-y"><span>Financial strength</span></div><div class="space-axis space-axis-x"><span>Industry strength</span></div><div class="space-origin">0</div><div class="space-point"><span class="space-point-label">Al Rawae<br />(+1.50, +1.16)</span></div><span class="space-y-value">+1.16</span><span class="space-x-value">+1.50</span></div><p class="small center muted">The position supports controlled aggressive growth: scalable, advance-funded, and asset-light.</p></section>
...
<section class="map-slide"><h2>BCG matrix</h2><img src="${assetBase}BCG.jpeg" alt="BCG matrix showing Al Rawae's service portfolio" /></section>
</section>
