...
<section><h2>PESTEL overview</h2><div class="grid3 small"><div class="card"><h3>Political</h3><p>Regional supply shocks; administrative inconsistency; sustainability policy; Beit Al Watan.</p></div><div class="card"><h3>Economic</h3><p>Exchange rates, imported inputs, construction inflation, client feasibility.</p></div><div class="card"><h3>Social</h3><p>Rapid preference shifts; uneven smart/sustainable adoption.</p></div><div class="card"><h3>Technological</h3><p>AI and BIM opportunity; scarce emerging-system skills.</p></div><div class="card"><h3>Environmental</h3><p>Heat, green standards, waste management, e-waste.</p></div><div class="card"><h3>Legal</h3><p>Licensing complexity, codes, Civil Defense, solar approvals.</p></div></div></section>
